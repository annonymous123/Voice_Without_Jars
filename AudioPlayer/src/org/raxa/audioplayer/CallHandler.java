...
public class CallHandler extends BaseAgiScript implements MessageInterface,VariableSetter
{
    ...
    */	}
    	...
    	language="english";					//SHOULD BE DELETED
    	...
    	if(isLanguageChanged==null || !Boolean.parseBoolean(isLanguageChanged)){
    					//char whichLanguage=getPatientOption(allLanguageVoiceLocation,"20000","1234569",2);			//SHOULD BE PLAYED IN DIFFERENT LANGUAGE AND SHOULD BE PRE_RECORDED like 1 for english (hindi k liye 2 dabaye),marathi sakha 3 daba etc.
