...
public class GetJson {
	...
	/**
	 * Make a call to Raxa Alert and parse the message and store the message in form of Reminder Class
	 * @param pid
	...
	public List<Reminder> getAlert(String pid){
		...
		try{
			...
			for(JsonNode alert:results){
				...
				else logger.info("Ignoring alert:"+alert+"as not of same date");
			}
		}
	...
	public Date getDate(String isoFormat){
		logger.info("converting isoFormat date"+isoFormat);
		Date date=null;
		try{
